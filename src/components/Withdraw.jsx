...
const Withdrawpage = () => {
  ...
  const handleWithdrawRequest = async () => {
    ...
    try {
      ...
      const response = await axios.get(`https://gainting.duckdns.org/api/auth/getuser/${userId}`, {
      ...
      if (response.data.success) {
        ...
        const withdrawResponse = await axios.post('https://gainting.duckdns.org/api/auth/createwithdraw', withdrawData,{  withCredentials: true,});
