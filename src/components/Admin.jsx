...
const AdminPanel = () => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get("https://gainting.duckdns.org/api/auth/getalluser");
  ...
  const fetchWithdrawals = async () => {
    try {
      const response = await axios.get("https://gainting.duckdns.org/api/auth/allwithdrawls");
  ...
  const handleUpdateDeposit = async (userId) => {
    ...
    try {
      await axios.post("https://gainting.duckdns.org/api/auth/updatedeposit", {
        userId,
        currency: "usdt",
